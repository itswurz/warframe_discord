...
def _fmt_stat(key: str, value: float) -> str:
    ...
    labels = {
        ...
        "ability_duration_percent":     f"+{value:.0f}% Ability Duration",
        "ability_strength_percent":     f"+{value:.0f}% Ability Strength",
        "ability_range_percent":        f"+{value:.0f}% Ability Range",
        ...
        "rifle_damage_percent":         f"+{value:.0f}% Rifle Damage",
        "pistol_damage_percent":        f"+{value:.0f}% Pistol Damage",
        "melee_damage_percent":         f"+{value:.0f}% Melee Damage",
        "crit_chance_percent":          f"+{value:.0f}% Crit Chance",
        "multishot_percent":            f"+{value:.0f}% Multishot",
        "status_chance_percent":        f"+{value:.0f}% Status Chance",
        "ammo_max_percent":             f"+{value:.0f}% Ammo Max",
        "reload_speed_percent":         f"+{value:.0f}% Reload Speed",
        "cold_damage_percent":          f"+{value:.0f}% Cold Damage",
        "heat_damage_percent":          f"+{value:.0f}% Heat Damage",
        "toxin_damage_percent":         f"+{value:.0f}% Toxin Damage",
        "impact_damage_percent":        f"+{value:.0f}% Impact Damage",
        "slash_damage_percent":         f"+{value:.0f}% Slash Damage",
        "puncture_damage_percent":      f"+{value:.0f}% Puncture Damage",
        "electricity_damage_percent":   f"+{value:.0f}% Electricity Damage",
        "slash_proc_duration_percent":  f"+{value:.0f}% Slash Proc Duration",
        "heavy_attack_efficiency_percent": f"+{value:.0f}% Heavy Atk Efficiency",
        "combo_efficiency_percent":     f"+{value:.0f}% Combo Efficiency",
        "ammo_conversion_ratio":        f"Ammo Convert ×{value:.0f}",
    }
